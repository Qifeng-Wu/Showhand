...
<html>
	...
	<head>
		...
		<script type="text/javascript">
				...
				if(self.frameElement && self.frameElement.tagName == "IFRAME" || $('#left').length > 0 || $('.jbox').length > 0){
					...
					layer.alert("未登录或登录超时。请重新登录，谢谢！", {skin:'layui-layer-red',closeBtn:0,icon:2});
					top.location = "${ctx}";
				}
		</script>
		<script type="text/javascript">
	...
	<body class="login-layout light-login" style="background-image: url('${ctxStatic }/common/login/images/meteorshower.jpg');">
					...
					<div class="col-sm-10 col-sm-offset-1" style="margin-top:-100px">
						<div class="login-container">
							...
							<div class="center">
								 <h1> 
									<br/>
									<img src="${ctxStatic }/common/login/images/icon_logo.png" width="45px">
									<span style="font-size: 24px;font-weight: bolder;color:#fff">游听后台管理系统</span>
									<br>
								 </h1> 
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												<span style="font-size: 18px;font-weight: bolder;">用户登录</span>
											</h4>
											...
											<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-35 pull-right btn btn-sm btn-primary" style="background-color: orange;">
										...
										<div class="toolbar clearfix">
											...
											<div style="width:100%; text-align: center;">
												<span class="user-signup-link" style="color: white;margin-right: 15px;">
													杭州嘘寒科技有限公司
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header green lighter bigger">
												<i class="ace-icon fa fa-repeat green"></i>
												<span style="font-size: 18px;font-weight: bolder;">修改密码</span>
											</h4>

											<div class="space-6"></div>
											<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/loginAfterModifyPwd" method="post" class="form-group form-horizontal">
												...
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="oldPassword" name="password" type="password" value="" maxlength="20" minlength="3"  class="form-control required" placeholder="原密码" />
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="newPassword" name="newPassword" type="password" value="" maxlength="20" minlength="3"  class="form-control required" placeholder="新密码" />
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="confirmNewPassword" name="confirmNewPassword" type="password" value="" maxlength="20" minlength="3" class="form-control required" equalTo="#newPassword" placeholder="确认密码" />
												...
												<!-- 	<label class="block">
													...
													<div class="clearfix">
														<button type="reset" class="width-30 pull-left btn btn-sm">
															...
															<span class="bigger-110">重新输入</span>
														</button>
										...
										<div class="toolbar center">
											<a href="#" data-target="#login-box" style="color: white;" class="back-to-login-link">
												<!-- <i class="ace-icon fa fa-arrow-left"></i> -->
												返回登录
											</a>
										</div>
