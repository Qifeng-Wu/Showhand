...
<body>
		<form:form id="inputForm" modelAttribute="grocerySlide" action="${ctx}/grocery/slide/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
		         ...
		         <td class="width-85"><form:textarea path="description" style="height:140px" htmlEscape="false" maxlength="2000" class="form-control required"/></td> 		         
		      </tr>		        		     
		 	</tbody>
		</table>
	</form:form>
