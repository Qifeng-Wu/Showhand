...
<body>
		<form:form id="inputForm" modelAttribute="qisCustomerFeedback" action="${ctx}/qis/qisCustomerFeedback/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<input type="hidden" id="picturesHidden" value='${qisCustomerFeedback.pictures}'/>	
