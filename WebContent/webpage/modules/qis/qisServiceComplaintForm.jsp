...
<body class="gray-bg">
	...
	<div class="col-sm-12" id="layer-photos-pictures">
		<form:form id="inputForm" modelAttribute="qisServiceComplaint" action="${ctx}/qis/qisServiceComplaint/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<input type="hidden" value="${qisServiceComplaint.state}" id="state">
		...
		<table class="table table-bordered table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">服务站点：</label></td>
					<td class="width-35">
						<form:input path="stationCode" htmlEscape="false" maxlength="30" class="form-control required"/>
					</td>
				</tr>								
				<tr>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="customerType.name" htmlEscape="false" maxlength="100" class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">行业类别：</label></td>
					<td class="width-35">
						<form:input path="industry.name" htmlEscape="false" maxlength="100" class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">工程师姓名：</label></td>
					<td class="width-35">
						<form:input path="engineer" htmlEscape="false" maxlength="100" class="form-control "/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="purchaseQuantity" htmlEscape="false" maxlength="100" class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">使用环境：</label></td>
					<td class="width-35">
						<form:input path="environmentDescroption" htmlEscape="false" maxlength="1000" class="form-control "/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:textarea path="failDescription" htmlEscape="false" maxlength="2000" class="form-control required"/>
					</td>
					<td class="width-15 active"><label class="pull-right">验证分析：</label></td>
					<td class="width-35">
						<form:textarea path="fieldAssayDescription" htmlEscape="false" maxlength="2000" class="form-control required"/>
					</td>
				</tr>							
		 	</tbody>
		</table>
		<h5 style="margin-top:25px">图片信息 </h5>
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		   	<tr>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		   	<c:forEach items="${qisServiceComplaintSnList}" var="qisServiceComplaintSn">							
				<tr>
		   ...
		   <tbody>							
		   		<tr>
					...
					<td class="width-35">
						...
						<input type="hidden" id="preliminaryOpinionManHidden" value="${qisServiceComplaint.preliminaryOpinionMan}"/>
					</td>
					...
					<td class="width-35">
						<input name="preliminaryOpinionTime" type="text" maxlength="20" class="form-control required"
								value="<fmt:formatDate value="${qisServiceComplaint.preliminaryOpinionTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
					</td>
				</tr>
		   		<tr>
			   		...
			   		<tr>
						...
						<td class="width-35">
							<input name="technologyHandleTime" type="text" maxlength="20" class="form-control required"
									value="<fmt:formatDate value="${qisServiceComplaint.technologyHandleTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
						</td>
					</tr>
			   		<tr>
			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
			   <tbody>							
					...
					<td class="width-35">
						...
						<input type="hidden" id="technologyManHidden" value="${qisServiceComplaint.technologyMan}"/>
					</td>
					<td class="width-15 active"><label class="pull-right">处理时间：</label></td>
					<td class="width-35">
						<input name="technologyHandleTime" type="text" maxlength="20" class="form-control required"
			   		...
			   		<tr>
						...
						<td class="width-35">
							<input name="qaHandlerTime" type="text" maxlength="20" class="form-control required"
									value="<fmt:formatDate value="${qisServiceComplaint.qaHandlerTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
						</td>
					</tr>
			   		<tr>
						<td class="width-15 active"><label class="pull-right">驳回原因：</label></td>
			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
			   <tbody>							
					...
					<td class="width-35">
						...
						<input type="hidden" id="qaHandlerHidden" value="${qisServiceComplaint.qaHandler}"/>
					</td>
					<td class="width-15 active"><label class="pull-right">处理时间：</label></td>
					<td class="width-35">
						<input name="qaHandlerTime" type="text" maxlength="20" class="form-control required"
