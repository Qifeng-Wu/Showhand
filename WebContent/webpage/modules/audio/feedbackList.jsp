...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">	
		<form:form id="searchForm" modelAttribute="aFeedback" action="${ctx}/audio/feedback/" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<tbody>
		<c:forEach items="${page.list}" var="aFeedback">
			<tr>
				<td><input type="checkbox" id="${aFeedback.id}" class="i-checks"></td>
				<td><img src='${aFeedback.fans.avatar}' width="30px" height="30px"/></td>
				<td>${aFeedback.fans.nickname}</td>
				<td>${aFeedback.type}</td>
				<td><fmt:formatDate value="${aFeedback.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>
					<a href="#" onclick="openDialogView('查看意见反馈', '${ctx}/audio/feedback/form?id=${aFeedback.id}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
