...
<body>
		<form:form id="inputForm" modelAttribute="aFeedback" action="${ctx}/audio/feedback/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<input type="hidden" id="picturesHidden" value='${aFeedback.pictures}'/>	
